...
export function Stats() {
  ...
  return <section className="bg-navy-900 py-12 border-y border-navy-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x-0 md:divide-x divide-navy-700">
          {stats.map((stat, index) => <div key={index} className="flex flex-col items-center justify-center p-4">
