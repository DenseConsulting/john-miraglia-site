    ...
    <section id="testimonials" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Client Review 1 */}
          <div className="bg-gray-50 p-8 rounded-sm border border-gray-100 shadow-sm flex flex-col">
            ...
            <blockquote className="text-gray-700 italic mb-8 flex-grow">
              "John is an excellent lawyer. He has been my lawyer for almost 8
              years, taking on the challenges of my son's case. He's always on
              time and looking out for your best interest! I have and will
              continue to refer him to others."
            </blockquote>
          ...
          {/* Peer Endorsement */}
          <div className="bg-navy-800 text-white p-8 rounded-sm shadow-md flex flex-col relative overflow-hidden">
